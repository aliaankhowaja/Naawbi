...
import naawbi.model.SubmissionComment;
...
public class AssignmentDetailsController implements Initializable {
    ...
    @FXML private Label latePolicyLabel;
    ...
    @FXML private Button unsubmitBtn;
    ...
    private void loadAssignmentDetails() {
        ...
        descriptionLabel.setText(assignment.getDescription() != null ? assignment.getDescription() : "No description provided.");
    }
    ...
    private void updateSubmissionUI() {
        ...
        if (submission.isSubmitted()) {
            ...
            if ("Late".equals(submission.getStatus())) {
                statusLabel.setStyle("-fx-font-size: 14px; -fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 4 8; -fx-background-color: #f0ad4e; -fx-background-radius: 12;");
            } else {
                statusLabel.setStyle("-fx-font-size: 14px; -fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 4 8; -fx-background-color: #5cb85c; -fx-background-radius: 12;");
            }
            
            fileLabel.setText(submission.getFilePath() != null ? new File(submission.getFilePath()).getName() : "No file attached");
            ...
            // Allow unsubmit if not past deadline, or if past deadline but late submissions are allowed
            ...
            if (pastDeadline && !assignment.isLateSubmissionsAllowed()) {
                ...
                statusLabel.setStyle("-fx-font-size: 14px; -fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 4 8; -fx-background-color: #d9534f; -fx-background-radius: 12;");
                uploadBtn.setDisable(true);
                submitBtn.setDisable(true);
            } else {
                statusLabel.setText("Not Submitted");
                statusLabel.setStyle("-fx-font-size: 14px; -fx-text-fill: gray; -fx-font-weight: bold; -fx-padding: 4 8; -fx-background-color: #f0f0f0; -fx-background-radius: 12;");
    ...
    private void loadComments() {
        ...
        try {
            ...
            for (SubmissionComment comment : comments) {
                VBox cb = new VBox(2);
                cb.setStyle("-fx-background-color: white; -fx-padding: 8; -fx-background-radius: 5; -fx-border-color: #eee; -fx-border-radius: 5;");
